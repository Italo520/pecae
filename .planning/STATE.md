...
- **Milestone 6 (Sprint 6)**: M06 (Avaliações), M09 (Moderação), M11 (Notificações) & MFA (Alertas) — Status: `active`
- **Milestone 7 (Sprint 7)**: M13 (Ads e Monetização) — Status: `planned`
- **Milestone 8 (Sprint 8)**: M12 (Analytics) & M10 (Assinaturas) — Status: `planned`

### Próxima Etapa Ativa:
- **Milestone 6 — Sprint 6**: Implementação das avaliações do vendedor/comprador, central de moderação, notificações estendidas e sistema de alertas de peças (MFA).
