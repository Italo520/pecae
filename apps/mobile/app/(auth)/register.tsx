      ...
      >
        <PecaeScreenContainer scrollable>
          <View style={styles.header}>
            ...
            >
              <View
                style={[styles.tagDot, { backgroundColor: colors.brand }]}
              />
              <Text
                style={[
                  styles.tagText,
            ...
            >
              Crie sua conta para entrar no ecossistema de peças e sucatas do
              PEÇAÊ.
            </Text>
          </View>

          <View
            style={[styles.contentWrapper, !isMobile && styles.desktopLayout]}
          >
            {!isMobile && (
              <View style={styles.brandingSection}>
                ...
                >
                  Conectando compradores e vendedores no maior marketplace de
                  peças automotivas do Brasil.
                </Text>
              </View>
            )}
                    ...
                    <TouchableOpacity
                      style={[
                        styles.checkbox,
                        {
                          ...
                          backgroundColor: watch("termsAccepted")
                            ? colors.brand
                            : "transparent",
                        },
                      ]}
                      onPress={() =>
                        setValue("termsAccepted", !watch("termsAccepted"))
                      }
                    >
                      {watch("termsAccepted") && (
