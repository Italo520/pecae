...
const COMMON_PART_CATEGORIES = [
  { id: 'engine', name: 'Motor e Componentes', icon: Settings },
  { id: 'transmission', name: 'Câmbio e Transmissão', icon: Disc },
  { id: 'electrical', name: 'Sistema Elétrico', icon: Zap },
  { id: 'suspension', name: 'Suspensão e Direção', icon: Wind },
  { id: 'cooling', name: 'Arrefecimento', icon: Thermometer },
  { id: 'brakes', name: 'Sistema de Freios', icon: ShieldAlert },
  { id: 'body', name: 'Lataria e Carroceria', icon: CarFront },
  { id: 'interior', name: 'Acabamento Interno', icon: Battery },
  { id: 'fluids', name: 'Fluidos e Filtros', icon: Droplets },
  { id: 'accessories', name: 'Acessórios', icon: Wrench },
];
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
        {COMMON_PART_CATEGORIES.map((category) => {
