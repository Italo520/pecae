            ...
            <div className="space-y-4">
              <label className="flex items-center justify-between p-4 rounded-xl bg-[var(--surface)] border border-transparent hover:border-[var(--border)] cursor-pointer hover:bg-[var(--surface-hover)] transition-colors">
                <div>
                  ...
                  <p className="text-xs text-[var(--muted)]">Receber alertas de buscas e mensagens por e-mail.</p>
                </div>
                <input 
                  type="checkbox" 
                  checked={prefs.email}
              ...
              <label className="flex items-center justify-between p-4 rounded-xl bg-[var(--surface)] border border-transparent hover:border-[var(--border)] cursor-pointer hover:bg-[var(--surface-hover)] transition-colors">
                <div>
                  ...
                  <p className="text-xs text-[var(--muted)]">Ver alertas em tempo real na barra de notificações.</p>
                </div>
                <input 
                  type="checkbox" 
                  checked={prefs.inApp}
