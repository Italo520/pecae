...
export default function VendedorNotificacoesPage() {
  ...
  if (isLoading) {
    return (
      <div className="flex-1 flex items-center justify-center text-[var(--muted)]">
        ...
        Carregando notificações do vendedor...
      </div>
    );
  }
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-xs text-[var(--muted)]">
                Alertas de moderação de anúncios, mensagens de compradores e sistema.
              </p>
            </div>
          </div>
        ...
        <div className="bg-[var(--surface)] border border-[var(--border)] rounded-2xl overflow-hidden divide-y divide-[var(--border)] shadow-sm">
          {notifications.length === 0 ? (
            <div className="p-12 text-center text-[var(--muted)] space-y-2">
              ...
              <p className="text-xs">Avisaremos você sobre atualizações dos seus veículos e negociações!</p>
            </div>
          ) : (
