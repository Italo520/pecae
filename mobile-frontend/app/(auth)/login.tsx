    ...
    <PecaeBackground>
      ...
      >
        <PecaeScreenContainer scrollable>
          ...
          >
            <View
              style={[styles.statusDot, { backgroundColor: colors.brand }]}
            />
            <Text
              style={[
                styles.statusText,
          ...
          <View style={styles.header}>
            ...
            <View
              style={[styles.titleUnderline, { backgroundColor: colors.brand }]}
            />
            <Text
              style={[
                styles.subtitle,
          ...
          >
            {!isMobile && (
              <View style={styles.brandingSection}>
                ...
                >
                  Construindo o futuro do mercado automotivo com tecnologia e
                  sustentabilidade.
                </Text>
              </View>
            )}
