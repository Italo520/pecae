...
async function run() {
  ...
  console.log('Connected to Supabase to revert ALL UUIDs to TEXT');
  ...
  const queries = [
    ...
    'ALTER TABLE vehicle_versions DROP CONSTRAINT IF EXISTS vehicle_versions_model_id_fkey',
    'ALTER TABLE vehicle_years DROP CONSTRAINT IF EXISTS vehicle_years_model_id_fkey',
    'ALTER TABLE vehicle_years DROP CONSTRAINT IF EXISTS vehicle_years_version_id_fkey',
    ...
    'ALTER TABLE vehicle_models ALTER COLUMN brand_id TYPE TEXT',
    
    'ALTER TABLE vehicle_versions ALTER COLUMN id TYPE TEXT',
    'ALTER TABLE vehicle_versions ALTER COLUMN model_id TYPE TEXT',
    
    'ALTER TABLE vehicle_years ALTER COLUMN id TYPE TEXT',
    'ALTER TABLE vehicle_years ALTER COLUMN model_id TYPE TEXT',
    'ALTER TABLE vehicle_years ALTER COLUMN version_id TYPE TEXT',
    ...
    // Re-add foreign keys
    'ALTER TABLE vehicle_models ADD CONSTRAINT vehicle_models_brand_id_fkey FOREIGN KEY (brand_id) REFERENCES vehicle_brands(id) ON DELETE CASCADE',
    'ALTER TABLE vehicle_versions ADD CONSTRAINT vehicle_versions_model_id_fkey FOREIGN KEY (model_id) REFERENCES vehicle_models(id) ON DELETE CASCADE',
    'ALTER TABLE vehicle_years ADD CONSTRAINT vehicle_years_model_id_fkey FOREIGN KEY (model_id) REFERENCES vehicle_models(id) ON DELETE CASCADE',
    'ALTER TABLE vehicle_years ADD CONSTRAINT vehicle_years_version_id_fkey FOREIGN KEY (version_id) REFERENCES vehicle_versions(id) ON DELETE CASCADE',
